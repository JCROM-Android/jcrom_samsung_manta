...
cp -a tmp/vendor/secapp/ffffffff000000000000000000000005.tlbin system/vendor/secapp/ffffffff000000000000000000000005.tlbin
cp -a tmp/vendor/lib/egl/libGLES_mali.so system/vendor/lib/egl/libGLES_mali.so
...
cp -a tmp/vendor/lib/libmalicore.bc system/vendor/lib/libmalicore.bc
cp -a tmp/vendor/lib/libstagefright_hdcp.so system/vendor/lib/libstagefright_hdcp.so
cp -a tmp/vendor/firmware/fimc_is_fw.bin system/vendor/firmware/fimc_is_fw.bin
cp -a tmp/vendor/firmware/fimc_is_fw2.bin system/vendor/firmware/fimc_is_fw2.bin
cp -a tmp/vendor/firmware/maxtouch.fw system/vendor/firmware/maxtouch.fw
cp -a tmp/vendor/firmware/mfc_fw.bin system/vendor/firmware/mfc_fw.bin
cp -a tmp/vendor/firmware/setfile.bin system/vendor/firmware/setfile.bin
cp -a tmp/vendor/firmware/setfile_4e5.bin system/vendor/firmware/setfile_4e5.bin
